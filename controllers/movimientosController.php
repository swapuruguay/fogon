...
class movimientosController extends Controller
{
    ...
    public function categorias()
    {
        ...
        $result = $modelCategorias->getAll();
        $listado;
        for ($i = 0; $i < count($result); $i++) {
            $listado[$i] = $result[$i];
        }

        $this->_view->categorias = $listado;
    ...
    public function editarCategoria($id)
    {
        ...
        $modelCategorias = $this->loadModel('categorias');
        $result = $modelCategorias->getById($id);

        $this->_view->categoria = $result;
    ...
    public function guardarCategoria()
    {
        ...
        $datos = array('id' => $id, 'nombre' => $nombre, 'importe' => $importe);
        $categoria = $modelo->buildCategoria($datos);
        $result = $modelo->update($categoria);
        $retorno = array('result' => $result);
